...
namespace Bolt\Extension\MichaelMezger\Helper\Tests;

use Bolt\Tests\BoltUnitTest;
use Bolt\Extension\MichaelMezger\Helper\HelperExtension;
...
class ExtensionTest extends BoltUnitTest
{
    ...
    public function testExtensionBasics()
    {
        ...
        $extension = new HelperExtension($app);

        $name = $extension->getName();
        $this->assertSame($name, 'Helper');
